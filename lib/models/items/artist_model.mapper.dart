...
class ArtistModelMapper extends SubClassMapperBase<ArtistModel> {
  ...
  static const Field<ArtistModel, List<AlbumModel>> _f$albums =
      Field('albums', _$albums, opt: true, def: const []);
  ...
  static const Field<ArtistModel, Map<String, dynamic>> _f$providerIds =
...
mixin ArtistModelMappable {
  ArtistModelCopyWith<ArtistModel, ArtistModel, ArtistModel> get copyWith =>
      _ArtistModelCopyWithImpl<ArtistModel, ArtistModel>(
          this as ArtistModel, $identity, $identity);
}

extension ArtistModelValueCopy<$R, $Out>
    on ObjectCopyWith<$R, ArtistModel, $Out> {
  ArtistModelCopyWith<$R, ArtistModel, $Out> get $asArtistModel =>
      $base.as((v, t, t2) => _ArtistModelCopyWithImpl<$R, $Out>(v, t, t2));
}

abstract class ArtistModelCopyWith<$R, $In extends ArtistModel, $Out>
...
class _ArtistModelCopyWithImpl<$R, $Out>
    extends ClassCopyWithBase<$R, ArtistModel, $Out>
    implements ArtistModelCopyWith<$R, ArtistModel, $Out> {
  _ArtistModelCopyWithImpl(super.value, super.then, super.then2);

  @override
  late final ClassMapperBase<ArtistModel> $mapper =
      ArtistModelMapper.ensureInitialized();
  @override
  ListCopyWith<$R, AlbumModel, AlbumModelCopyWith<$R, AlbumModel, AlbumModel>>
      get albums => ListCopyWith($value.albums, (v, t) => v.copyWith.$chain(t),
          (v) => call(albums: v));
  @override
  ListCopyWith<$R, AudioModel, AudioModelCopyWith<$R, AudioModel, AudioModel>>
  ...
  ListCopyWith<$R, ArtistModel,
      ...
      get similarArtists => ListCopyWith($value.similarArtists,
          (v, t) => v.copyWith.$chain(t), (v) => call(similarArtists: v));
  @override
  MapCopyWith<$R, String, dynamic, ObjectCopyWith<$R, dynamic, dynamic>>?
  ...
  @override
  ArtistModelCopyWith<$R2, ArtistModel, $Out2> $chain<$R2, $Out2>(
          Then<$Out2, $R2> t) =>
